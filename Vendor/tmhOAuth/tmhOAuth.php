...
class tmhOAuth
{
    ...
    private function set_user_agent()
    {
        ...
        $ssl = $this->is_ssl_enabled() ? '+SSL' : '-SSL';
     ...
     * @return mixed $data decoded from the URL encoded form
     */
     ...
     * @return int last received HTTP code
     */
     ...
     * @return int Length of the current curl buffer
     */
    ...
    {
        return $this->config['curl_ssl_verifyhost'] && $this->config['curl_ssl_verifypeer'];
    }
}